...
let GeofenceService = class GeofenceService {
    ...
    isInsideGeofence(employeeLat, employeeLon, branchLat, branchLon, radiusMeters) {
        const distance = this.calculateDistance(employeeLat, employeeLon, branchLat, branchLon);
