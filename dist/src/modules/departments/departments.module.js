...
exports.DepartmentsModule = DepartmentsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [departments_repository_1.DepartmentsRepository, departments_service_1.DepartmentsService],
        controllers: [departments_controller_1.DepartmentsController],
        exports: [departments_repository_1.DepartmentsRepository],
    })
], DepartmentsModule);
