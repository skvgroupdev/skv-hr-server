...
exports.ShiftsModule = ShiftsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [shifts_repository_1.ShiftsRepository, shifts_service_1.ShiftsService],
        controllers: [shifts_controller_1.ShiftsController],
        exports: [shifts_repository_1.ShiftsRepository, shifts_service_1.ShiftsService],
    })
], ShiftsModule);
