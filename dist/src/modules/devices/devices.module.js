...
const device_binding_schema_1 = require("./schemas/device-binding.schema");
    ...
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([
                ...
                { name: device_binding_schema_1.DeviceBinding.name, schema: device_binding_schema_1.DeviceBindingSchema },
            ]),
        ],
        providers: [devices_repository_1.DevicesRepository, devices_service_1.DevicesService],
        controllers: [devices_controller_1.DevicesController],
        exports: [devices_repository_1.DevicesRepository, devices_service_1.DevicesService],
    })
], DevicesModule);
